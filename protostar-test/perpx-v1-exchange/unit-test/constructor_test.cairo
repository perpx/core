...
func __setup__{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    ...
    %{
        ...
        call_data = [ids.OWNER, ids.TOKEN_ADDRESS, ids.INSTRUMENT_COUNT, ids.INSTRUMENT_COUNT]
...
func test_constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    %{
        ...
        assert prev_prices == context.call_data[4:], f'prev prices error, expected {context.call_data[4:]}, got {prev_prices}'
    %}
    return ();
}
