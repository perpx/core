...
@storage_var
func storage_positions(address : felt, instrument : felt) -> (position : Info):
end
...
namespace Position:
    ...
    func position{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        let (_position) = storage_positions.read(address, instrument)
    ...
    func update_position{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        alloc_locals
        let (info) = storage_positions.read(address, instrument)
        ...
        storage_positions.write(address, instrument, Info(fees, cost, size))
        return ()
    end
    ...
    func close_position{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        storage_positions.write(address, instrument, Info(0, 0, 0))
